"""
Upload 200 reviewer blog images từ cafe_images/reviewer_blog_photos/rev{XX}/
lên Cloudinary folder cafestory/reviewer_blogs.

Output: reviewer_blog_image_urls.json
{
  "1": {"1": ["url_a", "url_b"], "2": ["url_a", "url_b"]},        # rev 1: 2 blog
  ...
  "21": {"1": [...], "2": [...], "3": [...]},                     # rev 21: 3 blog
  ...
}

Chạy: python upload_reviewer_blog_images.py
"""
...
PHOTOS_DIR = Path(__file__).parent / "cafe_images" / "reviewer_blog_photos"
OUTPUT_JSON = Path(__file__).parent / "reviewer_blog_image_urls.json"
